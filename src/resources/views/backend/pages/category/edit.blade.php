                                ...
                                <div class="kt-widget11">
                                    <div class="row product-section">
                                          ...
                                          <div class="col-md-3">
                                                <div class="left">
                                                      <ul>
                                                            <li class="product-step active-product" id="cat-1">Basic Information</li>
                                                            <li class="product-step" id="cat-2">Attributes</li>
                                                            <li class="product-step" id="cat-3">Category Banner</li>
                                                      </ul>
                                                </div>
                                          </div>
                                          <!-- left part end -->
                                          ...
                                          <div class="col-md-9">
                                                ...
                                                <div class="row product-step-filter cat-1">
                                                      <form action="{{ route('category.update', $category->id) }}" style="width: 100%" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="row">
                                                                  <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                              ...
                                                                              <select name="icon" class="form-control" id="chosen2">
                                                                                    <option value="{{ $category->icon }}" selected>{{ $category->icon }}</option>
                                                                        ...
                                                                        <div class="form-group">
                                                                              ...
                                                                              <select name="status" class="form-control">
                                                                                    <option value="1" @if( $category->is_active == true ) selected @endif >Active</option>
                                                                                    <option value="0" @if( $category->is_active == false ) selected @endif >Inactive</option>
                                                                              </select>
                                                                        </div>
                                                                        <div class="form-group">
                                                                              <label>Select Attribute</label>

                                                                              <select name="attribute[]" class="form-control " id="chosen" multiple >
                                                                                    @foreach( \App\Models\Attribute::orderBy('id','desc')->get() as $attribute  )
                                                                                    <option value="{{ $attribute->id }}"
                                                                                          @foreach( $attribute->category as $single_category )
                                                                                                @if( $single_category->id == $category->id )
                                                                                                selected
                                                                                                @endif
                                                                                          @endforeach
                                                                        ...
                                                                        <div class="form-group">
                                                                              <label>Category Image (  Width: 800px, Height : 600px )</label> <br>
                                                                              <img src="{{ asset('images/category/'. $category->image) }}" id="image_preview_container" class="default-thhumbnail" width="100px" alt="">
                                                                              <br><br>
                                                                              <input type="file" class="form-control-file" name="image" id="image">
                                                                        </div>
                                                                        <div class="form-group">
                                                                              <label>Category Banner Image ( Width: 1150px, Height : 400px )</label> <br>
                                                                              <img src="{{ asset('images/category/'. $category->banner_image) }}" id="image_preview_container3" class="default-thhumbnail" width="100px" alt="">
                                                                              <br><br>
                                                                              <input type="file" class="form-control-file" name="banner_image" id="image3">
                                                                        </div>
                                                                        <div class="form-group">
                                                                              <label>Position</label>
                                                                              <input type="number" class="form-control" min="1" value="{{ $category->position }}" name="position">
                                                                              </div>
                                                                              <div class="form-group">
                                                ...
                                                <div class="row product-step-filter cat-2 hide-product">
                                                      <div class="col-md-12 table-responsive">
                                                            ...
                                                            <button type="button" data-content="{{ route('cat.attr.data.add.modal',$category->id) }}" data-target="#myModal" class="btn btn-outline-dark" data-toggle="modal">
                                                                Add
                                                            </button>

                                                            <!-- Modal -->
                                                            <div class="modal fade" id="addProductAttribute" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                  <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                              ...
                                                                              <div class="modal-body">
                                                                                    <form action="{{ route('cat.attr.add', $category->id) }}" method="post" class="ajax-form">
                                                                                          @csrf
                                                                                          <div class="form-group">
                                                            ...
                                                            <table class="table categry-attribute" id="datatable">
                                                                  <thead>
                                                                        <tr>
                                                                              <th>Id</th>
                                                                              <th>Varient</th>
                                                ...
                                                <div class="row product-step-filter cat-3 hide-product">
                                                      <div class="col-md-12 table-responsive">
                                                            <!-- Button trigger modal -->
                                                            ...
                                                            <div class="modal fade" id="addbanner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                  <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                              ...
                                                                              <div class="modal-body">
                                                                                    <form action="{{ route('cat.banner.add', $category->id) }}" method="post" class="ajax-form">
                                                                                          @csrf
                                                                                          <div class="form-group">
                                                            ...
                                                            <table class="table category-banner datatable" >
                                                                  <thead>
                                                                        <tr>
                                                                              <th>Position</th>
                                                                              <th>Image</th>
...
@section('per_page_js')
    ...
    <script>
      ...
      $(function() {
            $('.categry-attribute').DataTable({
                  processing: true,
                  serverSide: true,
                  ajax: "{{ route('cat.attr.data', $category->id) }}",
                  columns: [
                        {
                        data: 'id',
                        name: 'id'
            ...
            $('.category-banner').DataTable({
                  processing: true,
                  serverSide: true,
                  ajax: "{{ route('cat.banner.data', $category->id) }}",
                  columns: [
                        {
                        data: 'position',
                        name: 'position'
