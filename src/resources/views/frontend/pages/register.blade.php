...
@section('meta')
<!-- Title -->
<title>AB Electronics - Register Here</title>
@endsection
            ...
            <div class="row">
                  <div class="col-md-4 offset-md-4">
                        <div class="auth-box">
                              ...
                              <form action="{{ route('register') }}" class="ajax-form" method="post">
                                    ...
                                    <div class="input-group mb-4 mt-3">
                                          ...
                                          <input type="email" name="email" class="form-control" placeholder="Enter your email address " aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                    <div class="input-group mb-4 mt-3">
                                          <span class="input-group-text" id="basic-addon1">
                                    ...
                                    <div class="input-group mb-4 mt-3">
                                          ...
                                          <input type="date" name="birthdate" class="form-control" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                    <div class="input-group mb-4 mt-3">
                                          <span class="input-group-text" id="basic-addon1">
                                    ...
                                    <div class="input-group mb-4 mt-3">
                                          ...
                                          <input type="password" name="password_confirmation" class="form-control" placeholder="Enter your password again" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                    <div class="form-group make-auth">
                                          <button class="do-auth">Sign Up</button>
                                          <a class="do-auth-2" href="{{ route('login') }}">
                                                Sign In
                                          </a>
                                    </div>
