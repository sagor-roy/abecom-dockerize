		...
		<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper auth-box">
          ...
          @endif
					<div class="kt-login__head">
						<h3 class="kt-login__title">Password Email</h3>
					</div>
					<form class="kt-form" action="{{ route('post.email') }}" method="post">
						@csrf
										<div class="input-group">
											<input type="email" class="form-control" name="email" placeholder="Email">
										</div>
										<div class="kt-login__actions">
											<button id="kt_login_signin_submit" type="submit" class="btn btn-brand btn-pill kt-login__btn-primary">Send password reset link</button>
										</div>
									</form>
								</div>
							</div>	
