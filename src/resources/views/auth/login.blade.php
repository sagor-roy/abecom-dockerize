		...
		<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper auth-box">
			<div class="kt-login__container">
				<div class="kt-login__logo">
					<a href="#">
						<img src="{{ asset('images/logo/'.App\Models\ContactDetail::first()->logo) }}" width="300px">
					</a>
				</div>
						...
						@csrf
										...
										<div class="row kt-login__extra">
											...
											<div class="col kt-align-right">
												<a href="{{ route('get.email') }}" id="kt_login_forgot" class="kt-login__link">Forget Password ?</a>
											</div>
										</div>
								...
								{{-- <div class="kt-login__account">
									...
									&nbsp;&nbsp;
									<a href="{{ route('register.show') }}" id="kt_login_signup" class="kt-login__account-link">Sign Up!</a>
								</div> --}}
							</div>
						</div>
					</div>
