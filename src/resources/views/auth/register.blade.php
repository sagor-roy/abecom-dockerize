		...
		<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper auth-box">
          ...
          @endif
					<div class="kt-login__head">
						<h3 class="kt-login__title">Sign Up To Admin</h3>
					</div>
                    ...
                    <div class="input-group">
                      <input type="password" name="password_confirmation" class="form-control" placeholder="Password Confirmation">
										...
										<div class="kt-login__actions">
											<button id="kt_login_signin_submit" type="submit" class="btn btn-brand btn-pill kt-login__btn-primary">Sign Up</button>
										</div>
									</form>
								</div>
								...
								<div class="kt-login__forgot">
									<div class="kt-login__head">
										<h3 class="kt-login__title"><a href="{{ route('get.email') }}">Forgotten Password ?</a></h3>
								...
								<div class="kt-login__account">
									...
									&nbsp;&nbsp;
									<a href="{{ route('login.show') }}" id="kt_login_signup" class="kt-login__account-link">Sign In!</a>
								</div>
							</div>	
						</div>
					</div>
