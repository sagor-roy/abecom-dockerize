                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c" align="left">
                                                                                        <h1 style="color: #ffffff; line-height: 100%;">
                                                                                            <img src="{{ asset('images/logo/'.App\Models\ContactDetail::first()->logo) }}" width="300px" alt="">
                                                                                        </h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td class="esd-block-text" align="right">
                                                                                                                        <p><a target="_blank" style="font-size: 18px; line-height: 120%;" href="{{ route('shop') }}">Shop</a></p>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15b" align="center">
                                                                                        <h2 style="color: #333333; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;">Your Order Has Been Delivered!</h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30t" align="center">
                                                                                        <h2 style="color: #ffffff; font-size: 24px;">
                                                                                            {{ App\Models\ContactDetail::first()->offer_title }}
                                                                                        </h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p30t es-p15b es-p10r es-p10l" align="center">
                                                                                        <span class="es-button-border" style="background: #66b3b7 none repeat scroll 0% 0%;">
                                                                                        <a href="{{ route('home') }}" class="es-button" target="_blank" style="background: #66b3b7 none repeat scroll 0% 0%; border-color: #66b3b7; font-size: 18px; font-weight: normal;">
                                                                                            How was your experience. Write your review.
                                                                                        </a>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-infoblock made_with" align="center" style="font-size:0"><a target="_blank" href="https://viewstripo.email/?utm_source=templates&utm_medium=email&utm_campaign=accessory&utm_content=trigger_newsletter6">
                                                                                        <img src="{{ asset('images/logo/'.App\Models\ContactDetail::first()->logo) }}" alt width="125">
                                                                                    </a></td>
                                                                                </tr>
                                                                                <tr>
