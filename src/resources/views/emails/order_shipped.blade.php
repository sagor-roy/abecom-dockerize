                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15b" align="center">
                                                                                        <h2 style="color: #333333; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;">Your Order Has Shipped!</h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                    ...
                                                                    <td class="esd-container-frame" width="530" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p30t es-p15b es-p10r es-p10l" align="center"><span class="es-button-border" style="background: #66b3b7 none repeat scroll 0% 0%;"><a href="{{ route('offer') }}" class="es-button" target="_blank" style="background: #66b3b7 none repeat scroll 0% 0%; border-color: #66b3b7; font-size: 18px; font-weight: normal;">Awesome</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
