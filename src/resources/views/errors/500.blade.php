...
<div class="error">
<div class="error__subtitle">Sorry...</div>
<div class="error__description">Server Error</div>
<button class="error__button">
    <a href="{{ route('home') }}">
      <img src="{{ asset('images/logo/'.App\Models\ContactDetail::first()->logo) }} width="200px" alt="">
    </a>
</button>
</div>
